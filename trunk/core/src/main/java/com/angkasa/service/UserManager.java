...
public interface UserManager extends GenericManager<User, Long> {
    ...
    /**
     * Saves a user's information after inserting member/coop object
     *
     * @param user the user's information
     * @param updateMember true if update member
     * @param updateCoop true if update coop
     * @throws UserExistsException thrown when user already exists
     * @throws MemberNotFoundException thrown when member not found
     * @throws CoopNotFoundException thrown when coop not found
     * @return user the updated user object
     */
    User saveUser(final User user, boolean updateMember, boolean updateCoop) throws UserExistsException, MemberNotFoundException, CoopNotFoundException, MemberAlreadyHasUserException, CoopAlreadyHasUserException;
    ...
    User updatePassword(String username, String currentPassword, String recoveryToken, String newPassword, String applicationUrl, User requestingUser) throws UserExistsException;
    User updatePassword(String username, String currentPassword, String recoveryToken, String newPassword, String applicationUrl, User requestingUser, boolean sendMail) throws UserExistsException;

    User getByLogin(String username, String password);

    User getUsersByCoop(Long coopId);
    User getUsersByMember(Long memberId);

    User getByUsername(String username);
    User getByEmail(String email);

    User getByHexLogin(String username, String password);
}
