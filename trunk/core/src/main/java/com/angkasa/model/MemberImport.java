...
public class MemberImport extends BaseObject implements Serializable {
    ...
    public static final String COOP_MATCH_COOPCODE = "COOP_CODE";
    public static final String COOP_MATCH_BPACODE = "BPA_CODE";
    public static final String COOP_MATCH_SKMNO = "SKM_NO";
    ...
    private String coopMatchUsing = this.COOP_MATCH_COOPCODE;
    ...
    @Column(name = "coop_match_using")
    public String getCoopMatchUsing() {
        return coopMatchUsing;
    }

    public void setCoopMatchUsing(String coopMatchUsing) {
        this.coopMatchUsing = coopMatchUsing;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (coopMatchUsing != null ? !coopMatchUsing.equals(that.coopMatchUsing) : that.coopMatchUsing != null)
            return false;
        ...
        if (noOfColumns != null ? !noOfColumns.equals(that.noOfColumns) : that.noOfColumns != null) return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (noOfColumns != null ? noOfColumns.hashCode() : 0);
        result = 31 * result + (memberJson != null ? memberJson.hashCode() : 0);
        result = 31 * result + (coopMatchUsing != null ? coopMatchUsing.hashCode() : 0);
