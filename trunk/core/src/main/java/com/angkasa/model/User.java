...
public class User extends BaseObject implements Serializable, UserDetails {
    ...
    @Transient
    public boolean isCoopUser(){
        return hasRole(Constants.USER_ROLE_COOP);
    }

    @Transient
    public boolean isMemberUser(){
        return hasRole(Constants.USER_ROLE_MEMBER);
    }

    @Transient
    public boolean isDmsUser(){
        return hasRole(Constants.USER_ROLE_DMS);
    }

    @Transient
    public boolean isEventUser(){
        return hasRole(Constants.USER_ROLE_EVENT);
    }
...
//    @JoinColumn(name = "coop_id", referencedColumnName = "id", insertable = false, updatable = false)
    ...
    @Column(name = "icNumber", nullable = true, unique = true)
    ...
    @Column(name = "coopCode", nullable = true, unique = false)
