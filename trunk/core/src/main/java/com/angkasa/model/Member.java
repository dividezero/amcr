...
//    private String importEmployerCode;
    ...
    @Expose
    private String importBPACode;
    @Expose
    private String importCoopAmcrCode;
    @Expose
    private String importCoopMemberAknNo;
...
//    @JoinColumn(name = "user_id", referencedColumnName = "id", insertable = false, updatable = false)
    ...
    @Transient
    public String getImportBPACode() {
        return importBPACode;
    }

    public void setImportBPACode(String importBPACode) {
        this.importBPACode = importBPACode;
    }
    ...
    @Transient
    public String getImportCoopAmcrCode() {
        return importCoopAmcrCode;
    }

    @Transient
    public void setImportCoopAmcrCode(String importCoopAmcrCode) {
        this.importCoopAmcrCode = importCoopAmcrCode;
    }

    @Transient
    public String getImportCoopMemberAknNo() {
        return importCoopMemberAknNo;
    }

    public void setImportCoopMemberAknNo(String importCoopMemberAknNo) {
        this.importCoopMemberAknNo = importCoopMemberAknNo;
    }
    ...
    public String toString() {
        return "Member{" +
                ...
                ", importBPACode='" + importBPACode + '\'' +
                ", importCoopAmcrCode='" + importCoopAmcrCode + '\'' +
                ", importCoopMemberAknNo='" + importCoopMemberAknNo + '\'' +
                '}';
    }
    ...
    public boolean equals(Object o) {
        ...
        if (employer != null ? !employer.equals(member.employer) : member.employer != null) return false;
        if (employerCode != null ? !employerCode.equals(member.employerCode) : member.employerCode != null)
            return false;
        if (event != null ? !event.equals(member.event) : member.event != null) return false;
        if (eventId != null ? !eventId.equals(member.eventId) : member.eventId != null) return false;
        ...
        if (importBPACode != null ? !importBPACode.equals(member.importBPACode) : member.importBPACode != null)
            return false;
        if (importCoopAmcrCode != null ? !importCoopAmcrCode.equals(member.importCoopAmcrCode) : member.importCoopAmcrCode != null)
            return false;
        if (importCoopCode != null ? !importCoopCode.equals(member.importCoopCode) : member.importCoopCode != null)
            return false;
        if (importCoopMemberAknNo != null ? !importCoopMemberAknNo.equals(member.importCoopMemberAknNo) : member.importCoopMemberAknNo != null)
            return false;
    ...
    public int hashCode() {
        ...
        result = 31 * result + (importBPACode != null ? importBPACode.hashCode() : 0);
        result = 31 * result + (importCoopAmcrCode != null ? importCoopAmcrCode.hashCode() : 0);
        result = 31 * result + (importCoopMemberAknNo != null ? importCoopMemberAknNo.hashCode() : 0);
        return result;
    }
}
