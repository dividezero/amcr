...
<form:hidden path="description"/>
    ...
    <spring:bind path="systemSetting.displayName">
        ...
        <%--<form:input cssClass="form-control" path="displayName" id="displayName"  maxlength="255" readonly="true"/>--%>
        <div><h3>${systemSetting.displayName}</h3></div>
    ...
    <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
        ...
        <%--<form:input cssClass="form-control" path="description" id="description"  maxlength="250" readonly="true"/>--%>
        <div>${systemSetting.description}</div>
