...
<div class="col-sm-7">
    ...
    <c:choose>
        <c:when test="${currentUser.memberUser || empty param.coopId}" >
        ...
        <c:when test="${currentUser.coopUser || empty param.memberId}">
            <appfuse:label key="coopMember.coop" styleClass="control-label"/>
...
<br/>
        <c:if test="${not empty coopMember.memberHexNo}">
            <spring:bind path="coopMember.memberHexNo">
                <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            </spring:bind>
            <appfuse:label key="coopMember.memberHexNo" styleClass="control-label"/>
            <form:input cssClass="form-control" path="memberHexNo" id="memberHexNo"  maxlength="30" readonly="true"/>
            <form:errors path="memberHexNo" cssClass="help-block"/>
            </div>
        </c:if>
        ...
        <div class="form-group${(not empty status.errorMessage) ? ' has-error' : ''}">
            ...
            <form:input cssClass="form-control" path="membershipAknNo" id="membershipAknNo"  maxlength="30" />
