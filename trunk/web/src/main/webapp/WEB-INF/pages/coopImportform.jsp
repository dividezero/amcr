        ...
        <c:when test="${not empty coopImport.id}">
            ...
            <div class="form-group">
                ...
                <%--<button type="submit" class="btn btn-primary" name="saveAllToMembers" onclick="bCancel=false">--%>
                    <%--<i class="fa fa-plus"></i> <fmt:message key="button.saveAllToCoops"/>--%>
                <%--</button>--%>
            ...
            <div>
                ...
                <display:table name="coopList" class="table table-condensed table-striped table-hover" requestURI="" id="coopList" export="false" pagesize="50">
                    ...
                    <%--<display:column titleKey="title.actions" style="width: 5%" media="html" >--%>
                        ...
                        <%--<c:url var="editUrl" value="/coopImportEntryform?coopImportId=${coopImport.id}&importId=${coopList.importId}"/>--%>
